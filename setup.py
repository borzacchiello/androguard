...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'androguard = androguard.cli:entry_point',
            # Providing the same scripts as before
            'androapkid = androguard.cli:apkid',
            'androarsc = androguard.cli:arsc',
            'androaxml = androguard.cli:axml',
            'androdd = androguard.cli:decompile',
            'androdis = androguard.cli:disassemble',
            'androlyze = androguard.cli:analyze',
            'androsign = androguard.cli:sign',
        ]
    },
